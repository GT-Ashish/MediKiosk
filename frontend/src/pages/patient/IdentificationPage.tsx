...
export const IdentificationPage: React.FC = () => {
  const { setPatient, patient, goTo, goBack } = useKiosk()
    ...
    <div className="flex flex-col items-center justify-between min-h-[calc(100vh-140px)] max-w-2xl mx-auto px-4 py-6">
      ...
      <div className="w-full space-y-4 my-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-between p-5 sm:p-6 bg-[#FFFFFF] border-2 border-[#D9E2DF] hover:border-[#2F7D73] hover:bg-[#F9FBFA] active:bg-[#DCEDEA] rounded-2xl shadow-sm hover:shadow-md transition-all cursor-pointer group text-left"
        >
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-[#E8F4F1] text-[#2F7D73] flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-[#647471] mt-0.5">
                Use your Aadhaar to identify yourself
              </p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-[#EFF6FF] text-[#2563EB] flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
              {/* ID Badge Icon */}
              <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-[#647471] mt-0.5">
                Use your Ayushman Bharat Health ID
              </p>
            </div>
          </div>
          <svg className="w-6 h-6 text-[#647471] group-hover:text-[#2F7D73] group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        >
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-[#F6F8F7] text-[#647471] flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
              {/* User / Form Icon */}
              <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-xs flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl border border-[#D9E2DF]">
            <h3 className="text-2xl font-bold text-[#243331] mb-2">
              {activeModal === 'aadhaar' && 'Aadhaar Verification'}
              {activeModal === 'abha' && 'ABHA ID Verification'}
              {activeModal === 'manual' && 'Manual Patient Details'}
            </h3>
            <p className="text-sm text-[#647471] mb-4">
              Demo Simulation: No real Aadhaar or ABHA credentials are stored.
            </p>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-3.5 border border-[#D9E2DF] text-[#647471] font-semibold rounded-xl text-base hover:bg-gray-50"
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 py-3.5 bg-[#4F8A6D] text-white font-bold rounded-xl text-base hover:bg-[#3E6E56] shadow-md"
              >
                Confirm & Next →
              </button>
            </div>
